// Three.js animated hero background (dark blue theme)
(function(){
  ...
  function start(){
    ...
    scene.background = null; // transparent over CSS gradient
    ...
    // Blue lights
    const light1 = new THREE.PointLight(0x3b82f6, 1.2, 0);
    light1.position.set(5,5,10);
    const light2 = new THREE.PointLight(0x38bdf8, 1.1, 0);
    ...
    const particles = new THREE.Points(
      ...
      new THREE.PointsMaterial({ color: 0x93c5fd, size: 0.03 })
    );
    const count = 2200;
